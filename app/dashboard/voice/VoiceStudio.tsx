    ...
    <div className="space-y-5">
      ...
      <div className="space-y-5">
        {/* ── Zone A: transport. Sticks just under the 64px dashboard topbar
               ...
               audible. */}
        <div className="sticky top-16 z-10 -mx-4 bg-paper/85 px-4 py-2 backdrop-blur sm:-mx-6 sm:px-6">
          <VoicePreviewPlayer
          ...
          <div className="space-y-5 lg:col-span-7">
            <Panel label="Greeting" hint={`${form.greeting.length}/500`}>
              <textarea
                ...
                className="vs-surface w-full resize-none rounded-lg border border-line bg-surface-2/40 px-3.5 py-3 font-[family-name:var(--font-display)] text-[15px] leading-7 text-ink transition-colors duration-150 focus:border-teal-400 focus:bg-surface focus:outline-none focus:ring-2 focus:ring-teal-500/20"
                value={form.greeting}
        ...
        <div className="sticky bottom-0 z-10 -mx-4 border-t border-line bg-surface/90 px-4 py-3.5 backdrop-blur sm:-mx-6 sm:px-6">
