...
function SubLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="border-t border-b border-line bg-surface-2 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-ink-4 sm:px-6">
      {children}
    </p>
  );
}
...
function TestBox() {
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      {result && (
        <div className="mt-3 whitespace-pre-wrap rounded-md bg-surface-2 p-3 text-sm text-ink-2">
